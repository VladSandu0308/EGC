...
GLvoid Obstacle::Init()
{
	...
	shader->AddShader("Source/Teme/Tema2/Shaders/ObstacleVertex.glsl", GL_VERTEX_SHADER);
	shader->AddShader("Source/Teme/Tema2/Shaders/ObstacleFragment.glsl", GL_FRAGMENT_SHADER);
